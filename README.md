...
> **"비행 동역학 모델링부터 최적화 기반 유도 제어까지, 비행 제어 전 과정을 구현합니다."**
> <br> 본 프로젝트는 ROS2, PX4, rvizm Docker 등을 활용하여 임무별 무인기에 최적화된 유도(Guidance), 항법(Navigation), 제어(Control) 시스템을 설계하고 검증하는 통합 프레임워크입니다.
